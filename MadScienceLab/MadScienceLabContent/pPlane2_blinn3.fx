...
float4 DiffuseColor  = { 0.923810f, 0.923810f, 0.923810f, 1.000000f }; 
float  SpecularPower = 11.060001f; 
float4 SpecularColor = { 0.500000f, 0.500000f, 0.500000f, 1.000000f }; 
float4 EmissiveColor = { 0.000000f, 0.000000f, 0.000000f, 1.000000f }; 

texture file3; 
texture file3_; 

sampler2D file3Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <file3>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
sampler2D file3_Sampler = sampler_state  // TexCoord0 
{ 
   Texture = <file3_>; 
   MinFilter = Linear; 
   MagFilter = Linear; 
...
{ 
   //TODO: Modify the folowing code: 
   float4 color = tex2D( file3Sampler, vout.TexCoord0 ); 
